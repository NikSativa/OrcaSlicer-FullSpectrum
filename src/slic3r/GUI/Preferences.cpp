...
wxWindow* PreferencesDialog::create_general_page()
{
    ...
    */
    ...
    auto item_keep_painting = create_item_checkbox(_L("(Experimental) Keep painting after cut"), page, _L("Attempt to keep painted features (color / seam / support / fuzzy skin) after a plane cut.\nHighly experimental! Slow and may create artifacts."), 50, "keep_painting");
