...
//#endif
        mainframe->Thaw();
        // The PAGE_CHANGED handler posts EVT_GLVIEWTOOLBAR_3D during GL init, which would undo a
        // synchronous select_tab here, so defer it until pending events have been processed.
        CallAfter([this] {
