...
void TabPrint::build()
{
    ...
    optgroup->append_single_option_line("wall_loops", "strength_settings_walls#wall-loops");
        ...
        optgroup->append_single_option_line("enable_internal_bridge_detector"); // SnapOrka: experimental smart angle detection
    ...
    page = add_options_page(L("Multimaterial"), "custom-gcode_multi_material"); // ORCA: icon only visible on placeholders
        ...
        optgroup->append_single_option_line("enable_flush_vol_predictor");
        ...
        // SnapOrka: IDEX-style infill-first-on-color-change scheduling
        optgroup->append_single_option_line("infill_first_after_color_change");
